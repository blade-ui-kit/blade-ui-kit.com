...
final class IconSet extends Model
{
    ...
    protected array $rows = [
        ...
        [
    	    ...
    	    'repository' => 'https://github.com/enso-san/blade-gms-o',
    	    'composer' => 'enso-san/blade-gms-o',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
        [
    	    ...
    	    'repository' => 'https://github.com/enso-san/blade-gms-r',
    	    'composer' => 'enso-san/blade-gms-r',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
        [
    	    ...
    	    'repository' => 'https://github.com/enso-san/blade-gms-s',
    	    'composer' => 'enso-san/blade-gms-s',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
        [
    	    'id' => 91,
    	    'name' => 'google-material-symbols-outlined-filled',
    	    'repository' => 'https://github.com/enso-san/blade-gms-of',
    	    'composer' => 'enso-san/blade-gms-of',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
        [
    	    'id' => 92,
    	    'name' => 'google-material-symbols-rounded-filled',
    	    'repository' => 'https://github.com/enso-san/blade-gms-rf',
    	    'composer' => 'enso-san/blade-gms-rf',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
        [
    	    'id' => 93,
    	    'name' => 'google-material-symbols-sharp-filled',
    	    'repository' => 'https://github.com/enso-san/blade-gms-sf',
    	    'composer' => 'enso-san/blade-gms-sf',
    	    'ignore_rule' => null,
    	    'outline_rule' => null,
    	],
    ];
